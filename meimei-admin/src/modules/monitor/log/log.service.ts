...
export class LogService {
    constructor(
        ...
        @InjectRepository(OperLog) private readonly operLogRepository: Repository<OperLog>,
    ...
    /* 清空操作日志 */
    async cleanOperLog() {
        return this.operLogRepository.createQueryBuilder('operLog')
            .delete()
            .execute()
    }
    ...
    async cleanLogininfor() {
        return this.logininforRepository.createQueryBuilder('logininfor')
            .delete()
            .execute()
    }
}
