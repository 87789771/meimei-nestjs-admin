...
export class LogController {
  constructor(private readonly logService: LogService, private readonly excelService: ExcelService) {}
  /* 分页查询操作记录 */
  @Get('operlog/list')
  ...
  async logininforList(@Query(PaginationPipe) reqLogininforDto: ReqLogininforDto) {
  ...
  async exportLogininfor(@Body(PaginationPipe) reqLogininforDto: ReqLogininforDto) {
